...
struct CalendarDayView: View
{
    ...
    private func getDayData()
    {
        ...
        case .heart, .respiratory, .energy:
            self.viewModel.statisticsProvider.getMetaDataByIntervalWithIndicator(
                healthType: calendarType,
                indicatorType: .mean,
        ...
        case .asleep, .inbed:
            self.viewModel.statisticsProvider.getDataByIntervalWithIndicator(
                healthType: calendarType,
                indicatorType: .sum,
                for: DateInterval(start: date.startOfDay, end: date.endOfDay),
